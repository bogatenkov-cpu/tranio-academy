    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">🇹🇭 Таиланд • Экзамен</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="bg-white/80 backdrop-blur rounded-3xl shadow-2xl p-8 border-2 border-purple-200 text-center">
            <div className="text-6xl mb-6">📝</div>
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Экзамен по недвижимости в Таиланде</h1>
            <p className="text-lg text-gray-600 mb-8">
              Проверьте свои знания и получите сертификат брокера
            </p>

            <div className="bg-purple-50 rounded-2xl p-6 mb-8 text-left">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Информация об экзамене:</h2>
            ...
            <button
              onClick={startExam}
              className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl font-bold text-lg hover:shadow-lg transition-all"
            >
              Начать экзамен
            </button>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-gray-800">Tranio Academy</div>
                    <div className="text-xs text-gray-500">🇹🇭 Таиланд • Результаты</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-3xl shadow-2xl p-8 border-2 border-purple-200 text-center">
            {passed ? (
              <>
                ...
                <p className="text-xl text-gray-600 mb-8">Вы успешно прошли экзамен</p>
              </>
            ) : (
              <>
                <div className="text-6xl mb-4">📚</div>
                <h1 className="text-4xl font-bold text-orange-600 mb-4">Продолжайте учиться</h1>
                <p className="text-xl text-gray-600 mb-8">Для сертификата нужно набрать 80%</p>
              </>
            )}

            <div className="bg-purple-50 rounded-2xl p-8 mb-8">
              <div className="text-6xl font-bold text-purple-700 mb-2">{percentage}%</div>
            ...
            {passed && (
              <div className="bg-yellow-50 border-2 border-yellow-200 rounded-2xl p-6 mb-8">
                ...
                <h3 className="text-2xl font-bold text-yellow-800 mb-2">Сертификат брокера</h3>
                <p className="text-yellow-700">Вы получили сертификат специалиста по недвижимости в Таиланде!</p>
              </div>
            )}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-600">
                Вопрос {currentQuestionIndex + 1} / {examQuestions.length}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {/* Вопрос */}
        <div className="bg-white/80 backdrop-blur rounded-3xl shadow-2xl p-8 mb-6 border-2 border-purple-200">
          <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm text-gray-600">
            {answeredCount === examQuestions.length ? (
              <span className="text-green-600 font-semibold">Все вопросы отвечены</span>
            ) : (
              <span>Осталось: {examQuestions.length - answeredCount}</span>
            )}
          </div>
