...
import { MapPin, TrendingUp, Users, Building2, DollarSign, Info, Waves, Mountain, School } from 'lucide-react';
            ...
            <div>
              ...
              <div className="text-slate-700 text-sm sm:text-base leading-relaxed space-y-2">
                ...
                <p className="text-sm">
                  ...
                  <span className="font-semibold text-blue-600"> ~70% покупателей курортной недвижимости</span> — иностранцы.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="p-5 bg-cyan-50 rounded-xl border border-cyan-200">
                  ...
                  <div className="space-y-2 text-sm text-cyan-800">
                    ...
                    <div>• <span className="font-semibold">Карон, Ката:</span> комфортные семейные пляжи юга, развитая инфраструктура</div>
                    <div>• <span className="font-semibold">Най Харн:</span> семейный пляж юга, комфортное купание, локальная атмосфера</div>
                ...
                <div className="space-y-4">
                  <div className="p-5 bg-purple-50 rounded-xl border border-purple-200">
                    ...
                    <div className="text-sm text-purple-800 space-y-2">
                      <p>Крупнейший инфраструктурный кластер Пхукета: длинный пляж (~8 км), бич-клабы, Boat Avenue, Porto de Phuket, гольф.</p>
                      <p>Экосистема для экспат-семей: школы, рестораны, шопинг. В глубине — закрытые посёлки вилл.</p>
                    </div>
                  </div>
                  ...
                  <div className="p-5 bg-blue-50 rounded-xl border border-blue-200">
                    ...
                    <div className="text-sm text-blue-800 space-y-1">
                      ...
                      <div>• Лайан / север Банг Тао: от <span className="font-bold">~$1 800/м²</span></div>
                    </div>
                  </div>
              ...
              {selectedLocation === 'surin' && (
                <div className="space-y-4">
                  <div className="p-5 bg-pink-50 rounded-xl border border-pink-200">
                    ...
                    <div className="text-sm text-pink-800 space-y-2">
                      <p>Нишевый элитный сегмент между Банг Тао и Камалой. Виллы и панорамные резиденции на склонах.</p>
                      <p>Ограниченная коммерческая среда — минимум магазинов. «Первоклассная» видовая локация 20+ лет.</p>
                    </div>
                  </div>
                  ...
                  <div className="p-5 bg-rose-50 rounded-xl border border-rose-200">
                    ...
                    <div className="text-sm text-rose-800">
                      Обеспеченные владельцы вилл, ценители панорамных видов. Нишевый сегмент с ограниченной инфраструктурой.
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
                    ...
                    <div className="text-sm text-teal-800 space-y-2">
                      <p>Уединённый люксовый мыс. Яхтенное сообщество, рядом глубоководный порт (Phuket Yacht Haven).</p>
                      <p>Отели со своими мини-пляжами: Sri Panwa, Pullman, Anantara. Восточное побережье — приливо-зависимое.</p>
                    </div>
                  </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-3xl shadow-lg border border-emerald-100 overflow-hidden">
            ...
            <div className="p-6">
              ...
              {selectedSamuiArea === 'bophut' && (
                <div className="space-y-3">
                  <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-200">
                    ...
                    <div className="text-sm text-emerald-800">
                      Туристический хаб: Fisherman&apos;s Village, рестораны, пирсы. Большой Будда, Wat Plai Laem. Близость к аэропорту. Bangkok Hospital Samui и клиники высокого уровня. Международные школы.
                    </div>
                  </div>
                  <div className="p-4 bg-teal-50 rounded-xl border border-teal-200">
              ...
              {selectedSamuiArea === 'maenam' && (
                <div className="space-y-3">
                  <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                  <div className="font-bold text-green-900 mb-2">🏖️ Семейная локация</div>
                    <div className="text-sm text-green-800">
                      Спокойный широкий пляж, местные рынки, кафе. Four Seasons. Ориентация на долгосрочную аренду и семейных резидентов.
                    </div>
                  </div>
                  <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-200">
                    <div className="flex items-center gap-2 mb-2">
              ...
              {selectedSamuiArea === 'talingnham' && (
                <div className="space-y-3">
                  <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
                    <div className="font-bold text-purple-900 mb-2">🌅 Премиальные закаты и wellness</div>
                    <div className="text-sm text-purple-800">
                      Низкая плотность застройки, лучшие sunset-виды на острове. Wellness-ретриты, буддийские храмы, 5* резорты.
                    </div>
                  </div>
