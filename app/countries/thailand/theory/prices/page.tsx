...
import { Home, ShoppingCart, TrendingUp, Calendar, Gift, Info, ChevronRight, User, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Урок 1: Налоги в Таиланде</div>
              </div>
            </Link>
            <div className="flex items-center gap-4">
              <Link href="/" className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-100 text-purple-700 font-medium hover:bg-purple-200 transition-all">
      ...
      <div className="bg-gradient-to-r from-purple-200 via-pink-200 to-rose-200">
        <div className="max-w-4xl mx-auto px-6 py-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-sm text-purple-600 font-medium mb-1">Урок 1 • Теория</div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-6">
        ...
        <div className="flex gap-4 pt-6">
          ...
          <button className="flex-1 py-4 px-6 rounded-2xl bg-gradient-to-r from-purple-200 to-pink-200 text-purple-800 font-semibold hover:shadow-lg transition-all">
            Следующий урок →
          </button>
        </div>
